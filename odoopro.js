...
var payload = '{"jsonrpc":"2.0","method":"call","params":{"model":"hr.attendance","domain":[["employee_id","=",'+id_empleado+'],["employee_id","=",'+id_empleado+']],"fields":["check_in","check_out"],"limit":80,"sort":"","context":{"lang":"es_ES","tz":"Europe/Madrid","uid":51,"active_model":"hr.employee","active_id":'+id_empleado+',"active_ids":['+id_empleado+'],"search_default_employee_id":'+id_empleado+',"default_employee_id":'+id_empleado+',"search_disable_custom_filters":true}},"id":546348831}';
var horas = 0;
var minutos = 0;
var segundos = 0;
...
function semana(){
    ...
    var payloadSemana = '{"jsonrpc":"2.0","method":"call","params":{"args":[],"model":"hr.attendance","method":"read_group","kwargs":{"context":{"lang":"es_ES","tz":"Europe/Madrid","uid":51,"active_model":"hr.employee","active_id":'+id_empleado+',"active_ids":['+id_empleado+'],"search_default_employee_id":'+id_empleado+',"default_employee_id":'+id_empleado+',"search_disable_custom_filters":true,"group_by":"check_in"},"domain":[["employee_id","=",'+id_empleado+'],["employee_id","=",'+id_empleado+'],"&",["check_in",">=","'+inicioSemana+'"],["check_in","<","'+finSemana+'"]],"fields":["x_studio_nombre_empresa","x_studio_nif_empresa","x_studio_field_Vq3gL","employee_id","check_in","check_out","worked_hours"],"groupby":["check_in:week"],"orderby":"","lazy":true}},"id":591586260}';
    $.ajax({
    ...
    var payloadSemanaPasada = '{"jsonrpc":"2.0","method":"call","params":{"args":[],"model":"hr.attendance","method":"read_group","kwargs":{"context":{"lang":"es_ES","tz":"Europe/Madrid","uid":51,"active_id":'+id_empleado+',"active_ids":['+id_empleado+'],"params":{"action":778,"active_id":'+id_empleado+',"model":"hr.attendance","view_type":"list","menu_id":377},"search_default_employee_id":'+id_empleado+',"default_employee_id":'+id_empleado+',"search_disable_custom_filters":true,"group_by":"check_in"},"domain":[["employee_id","=",'+id_empleado+'],["employee_id","=",'+id_empleado+'],"&",["check_in",">=","'+inicioSemanaPasada+'"],["check_in","<","'+finSemanaPasada+'"]],"fields":["x_studio_nombre_empresa","x_studio_nif_empresa","x_studio_field_Vq3gL","employee_id","check_in","check_out","worked_hours"],"groupby":["check_in:week"],"orderby":"","lazy":true}},"id":6608434}';
    $.ajax({
        url: 'https://cosmomedia-serdata.odoo.com/web/dataset/call_kw/hr.attendance/read_group',
        type: "POST",
        dataType: "json",
...
function getFinSemana(fecha) {
    ...
    fecha.setDate(diff);
    return (fecha.getYear() + 1900) + "-" + ("0" + (fecha.getMonth() + 1)).slice(-2) + "-" + ("0" + fecha.getDate()).slice(-2) + " 23:59:59";
}
        ...
        success: function(data){
            ...
            $.each(data.result.records, function(key, value) {
                ...
                if(value.check_out) {
                    ...
                    trabajando = true;
                    salida = new Date();
                    salida.setHours(salida.getHours() - diff_to_GMT(salida));
                }
                if(esHoy(entrada)) {
...
function init() {
    ...
    var interval = setInterval(function(){
        if(!localStorage.getItem('id_empleado_odoo')) {
            autoSetIdEmpleado();
            id_empleado = localStorage.getItem("id_empleado_odoo");
            recalcularTiempos();
        } else {
